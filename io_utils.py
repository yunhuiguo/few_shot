...
def parse_args(script):
    ...
    parser.add_argument('--n_shot'      , default=50, type=int,  help='number of labeled data in each class, same as n_support') #baseline and baseline++ only use this parameter in finetuning
