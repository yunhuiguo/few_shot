...
class CustomDatasetFromImages(Dataset):
    def __init__(self, csv_path="/mnt/data/few_shot/ISIC/ISIC2018_Task3_Training_GroundTruth/ISIC2018_Task3_Training_GroundTruth.csv", \
        image_path = "/mnt/data/few_shot/ISIC/ISIC2018_Task3_Training_Input/"):
        """
        Args:
