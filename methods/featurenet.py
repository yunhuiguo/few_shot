...
class featurenet(MetaTemplate):
    def __init__(self, model_func,  n_way, n_support, loss_type = 'softmax'):
        super(featurenet, self).__init__( model_func,  n_way, n_support, change_way = False)
    ...
    def train_loop(self, epoch, train_loader, optimizer, val_loader, novel_loader, novel_loader_save ): #overwrite parrent function
        print_freq = 10
        ...
        for i, (x, _) in enumerate(val_loader):
            ...
            if i % print_freq==0:
                ...
                ####################################################            
                novel_file = os.path.join(os.getcwd() + "/tmp",  "novel_val_" + str(epoch)+ ".hdf5") 
